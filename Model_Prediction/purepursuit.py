...
class State:
    def __init__(self, x=0.0, y=0.0, yaw=0.0, v=0.0):
        self.target_velocity_publisher = rospy.Publisher('/target_velocity', Twist, queue_size=2)
        self.x = x
        self.y = y
        self.yaw = yaw
        self.v = v
    ...
    def update(self, a, delta):
        ...
        v_msg=Twist()
        v_msg.linear.x=self.vx
        v_msg.linear.y=self.vy
        self.target_velocity_publisher.publish(v_msg)
